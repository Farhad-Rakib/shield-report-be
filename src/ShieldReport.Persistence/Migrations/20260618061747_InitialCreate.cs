    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    WidgetOrder = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "[]"),
                    HiddenWidgets = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "[]"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_dashboard_preferences", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_user_dashboard_preferences_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
